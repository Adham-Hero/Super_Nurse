...
export default function Hero() {
  ...
  return (
    <section id="home" style={{ maxWidth: 1180, margin: "0 auto", padding: "130px 24px 60px" }}>
      ...
      <p style={{ maxWidth: 560, fontSize: 16, lineHeight: 1.8, color: t.muted, marginBottom: 30 }}>
        {s.heroSubtitle}
      </p>
